...
const languagePacks = {
  'zh-cn': {
    ...
    'inject.duration7Days': '7天，复利0.3%',
    'inject.duration15Days': '15天，复利0.6%',
    'inject.duration30Days': '30天，复利1.0%',
    'inject.duration45Days': '45天，复利1.2%',
    'inject.duration7Minutes': '7分钟，复利0.3%',
    'inject.duration15Minutes': '15分钟，复利0.6%',
    ...
    'redeem.getBonus': '获得全部收益 (OSK+OSP)',
    ...
    'redeem.confirmForfeitLine1': '确认放弃',
    'redeem.rewards': '收益',
  ...
  'zh-tw': {
    ...
    'inject.duration7Days': '7天，複利0.3%',
    'inject.duration15Days': '15天，複利0.6%',
    'inject.duration30Days': '30天，複利1.0%',
    'inject.duration45Days': '45天，複利1.2%',
    'inject.duration7Minutes': '7分鐘，複利0.3%',
    'inject.duration15Minutes': '15分鐘，複利0.6%',
    ...
    // Redeem Options Modal
    'redeem.title': '選擇贖回方式',
    'redeem.principalOnly': '贖回本金',
    'redeem.principalOnlyDesc': '僅取回本金，放棄所有收益',
    'redeem.forfeitRewards': '注意：將損失所有累計收益',
    'redeem.reinvest': '復投贖回',
    'redeem.reinvestDesc': '投入新資金，連本帶利解鎖舊資金',
    'redeem.recommended': '推薦',
    'redeem.getBonus': '獲得全部收益 (OSK+OSP)',
    'redeem.newAmount': '新質押金額',
    'redeem.newDuration': '新質押週期',
    'redeem.minAmount': '最低需投入 {amount}',
    'redeem.minDuration': '最低需質押 {days}',
    'redeem.confirmPrincipal': '確認僅贖回本金',
    'redeem.confirmReinvest': '確認復投並贖回',
    'redeem.dailyLimitReached': '今日贖回額度已達上限',
    'redeem.insufficientStakeLimit': '今日可質押額度不足',
    'redeem.back': '返回',
    'redeem.currentValue': '當前總價值',
    'redeem.lostReward': '預計損失收益',
    'redeem.confirmForfeit': '確認放棄 {amount} 收益獲取本金？',
    'redeem.confirmForfeitLine1': '確認放棄',
    'redeem.rewards': '收益',
  ...
  'en': {
    ...
    'inject.duration7Minutes': '7 minutes, 0.3% compound',
    'inject.duration15Minutes': '15 minutes, 0.6% compound',
    'inject.duration30Minutes': '30 minutes, 1.0% compound',
    'inject.days1': '1 Day',
    'inject.days7': '7 Days',
    'inject.rate1': '',
    'inject.rate7': 'Compound 0.3%',
    ...
    'redeem.getBonus': 'Get All Rewards (OSK+OSP)',
    ...
    'redeem.confirmForfeitLine1': 'Confirm forfeit',
  ...
  'ja': {
    ...
    'inject.duration7Minutes': '7分、複利0.3%',
    'inject.duration15Minutes': '15分、複利0.6%',
    ...
    'inject.soldOut': '現在、グローバルステーキングの割り当てはすべて売り切れです',

    // Redeem Options Modal
    'redeem.title': '償還方法を選択',
    'redeem.principalOnly': '元本のみ償還',
    'redeem.principalOnlyDesc': '元本のみ回収し、すべての報酬を放棄',
    'redeem.forfeitRewards': '注意：累積されたすべての報酬が失われます',
    'redeem.reinvest': '再投資して償還',
    'redeem.reinvestDesc': '新しい資金を投入し、元本と利息を解除',
    'redeem.recommended': '推奨',
    'redeem.getBonus': 'すべての報酬を獲得 (OSK+OSP)',
    'redeem.newAmount': '新しいステーク額',
    'redeem.newDuration': '新しいステーク期間',
    'redeem.minAmount': '最低投入額 {amount}',
    'redeem.minDuration': '最低ステーク期間 {days}',
    'redeem.confirmPrincipal': '元本のみ償還を確認',
    'redeem.confirmReinvest': '再投資して償還を確認',
    'redeem.dailyLimitReached': '本日の償還限度額に達しました',
    'redeem.insufficientStakeLimit': '本日のステーク枠が不足しています',
    'redeem.back': '戻る',
    'redeem.currentValue': '現在の総価値',
    'redeem.lostReward': '予想損失報酬',
    'redeem.confirmForfeit': '{amount}の報酬を放棄して元本を取得しますか？',
    'redeem.confirmForfeitLine1': '放棄を確認',
    'redeem.rewards': '報酬',
  ...
  'ko': {
    ...
    'inject.duration7Minutes': '7분, 복리 0.3%',
    'inject.duration15Minutes': '15분, 복리 0.6%',
    ...
    // Redeem Options Modal
    'redeem.title': '상환 방법 선택',
    'redeem.principalOnly': '원금만 상환',
    'redeem.principalOnlyDesc': '원금만 회수하고 모든 보상 포기',
    'redeem.forfeitRewards': '주의: 누적된 모든 보상을 잃게 됩니다',
    'redeem.reinvest': '재투자 및 상환',
    'redeem.reinvestDesc': '새 자금을 투입하여 기존 원금과 이자 잠금 해제',
    'redeem.recommended': '추천',
    'redeem.getBonus': '모든 보상 받기 (OSK+OSP)',
    'redeem.newAmount': '새 스테이킹 금액',
    'redeem.newDuration': '새 스테이킹 기간',
    'redeem.minAmount': '최소 투입 {amount}',
    'redeem.minDuration': '최소 스테이킹 {days}',
    'redeem.confirmPrincipal': '원금만 상환 확인',
    'redeem.confirmReinvest': '재투자 및 상환 확인',
    'redeem.dailyLimitReached': '일일 상환 한도 도달',
    'redeem.insufficientStakeLimit': '일일 스테이킹 한도 부족',
    'redeem.back': '뒤로',
    'redeem.currentValue': '현재 총 가치',
    'redeem.lostReward': '예상 손실 보상',
    'redeem.confirmForfeit': '{amount} 보상을 포기하고 원금을 받으시겠습니까?',
    'redeem.confirmForfeitLine1': '포기 확인',
    'redeem.rewards': '보상',
